...
```
Clonar el repositorio de ProyectoFinal en su máquina local utilizando el siguiente comando: git clone https://github.com/ignaci1o/AppBlog.git
Navegue hasta el directorio ProyectoFinal utilizando el comando cd blog.
